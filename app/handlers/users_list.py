    ...
    async def get(self):
        ...
        if qtext:
            ...
            must.append({
                "multi_match": {
                    ...
                    "type": "phrase_prefix",  # Can also use "best_fields"
                    "fuzziness": "AUTO"
                }
            })
        ...
        try:
            ...
            for hit in res["hits"]["hits"]:
                ...
                if qtext:
                    user_data["score"] = hit.get("_score", None)
            ...
            self.set_status(500)
            self.finish({"error": {"code": "FETCH_ERROR", "message": ERROR_MESSAGES.get("fetch_error", "Could not retrieve users")}})
