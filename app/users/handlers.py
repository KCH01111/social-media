...
from auth.handlers import BaseHandler, jwt_required, es_io
...
class UserDetailHandler(BaseUserHandler):
    async def get(self, username: str):
        ...
        try:
            ...
            self.send_error(500, reason="fetch_error")
...
class MeHandler(BaseUserHandler):
    ...
    async def patch(self):
        ...
        try:
            ...
            self.send_error(500, reason="update_error")
    ...
    async def delete(self):
        try:
            ...
            self.send_error(500, reason="delete_error")
...
class UsersListHandler(BaseUserHandler):
    async def get(self):
        ...
        try:
            ...
            self.finish({"users": items, "pagination": {"current_page": page, "page_size": size, "total_results": total, "total_pages": total_pages}})
        except Exception:
...
class UserSearchHandler(BaseUserHandler):
    async def get(self):
        ...
        try:
            ...
            self.send_error(500, reason="search_error")
